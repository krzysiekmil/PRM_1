package pjwstk.s20124.prm_1.utils
...
internal class DbHelper(context: Context) : SQLiteOpenHelper(context, "BookLibrary.db", null, 1) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        val query = "CREATE TABLE IF NOT EXISTS $TABLE_NAME ($COLUMN_ID INTEGER PRIMARY KEY AUTOINCREMENT, $COLUMN_TITLE TEXT, $COLUMN_AUTHOR TEXT, $COLUMN_PAGES INTEGER);"
        db.execSQL(query)
    }
